...
describe('useCanvasEngine', () => {
  ...
  const mockPersonalCanvas = {
    id: 'canvas-123',
    userId: 'user-123',
    valueProposition: 'Experienced engineer with AI expertise',
    keyActivities: ['Development', 'Mentoring', 'Architecture'],
    strengthsAdvantage: 'Strong technical and leadership skills',
    targetRoles: ['Tech Lead', 'Engineering Manager'],
    channels: ['LinkedIn', 'GitHub', 'Conferences'],
    resources: ['Technical Blog', 'Open Source', 'Network'],
    careerDirection: 'Moving towards technical leadership',
    painRelievers: ['Process automation', 'Code quality'],
    gainCreators: ['Team productivity', 'Innovation'],
  ...
  describe('saveCanvas', () => {
    ...
    it('should update existing canvas when canvas is loaded', async () => {
      ...
      const updatedData = {
        ...
        strengthsAdvantage: 'Updated strength',
        targetRoles: ['Updated role'],
        channels: ['Updated channel'],
        resources: ['Updated resource'],
        careerDirection: 'Updated direction',
        painRelievers: ['Updated pain'],
        gainCreators: ['Updated gain'],
  ...
  describe('regenerateCanvas', () => {
    it('should regenerate canvas using AI operation', async () => {
      ...
      const generatedCanvas = {
        ...
        strengthsAdvantage: 'AI generated strength',
        targetRoles: ['AI generated role'],
        channels: ['AI generated channel'],
        resources: ['AI generated resource'],
        careerDirection: 'AI generated direction',
        painRelievers: ['AI generated pain reliever'],
        gainCreators: ['AI generated gain creator'],
        lastGeneratedAt: '2025-01-15T00:00:00Z',
        needsUpdate: false,
        createdAt: '2025-01-15T00:00:00Z',
        updatedAt: '2025-01-15T00:00:00Z',
